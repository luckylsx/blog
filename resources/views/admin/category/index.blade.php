...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{route('admin/info')}}">首页</a> 分类管理
    </div>
    <!--面包屑导航 结束-->
    ...
    <script type="text/javascript">
        function changeOrder(obj,cate_id){
            ...
            var data = {'_token':'{{csrf_token()}}','cate_order':cate_order,'cate_id':cate_id};
            $.post("{{route('admin_cate_changeorder')}}",data,function (res) {
                if(!res.status){
